import { LayoutDashboard, TrendingUp, Wallet, Users, Sparkles, Building2, Home } from 'lucide-react';
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {item.badge && (
                <span className="hidden lg:inline-block text-[10px] font-bold px-1.5 py-0.5 rounded-md bg-purple-500/20 text-purple-300 mr-auto">
                  {item.badge}
                </span>
              )}
            </button>
