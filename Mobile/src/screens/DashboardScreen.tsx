...
export default function DashboardScreen({ navigation }: any) {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <BottomSheet ref={bottomSheetRef} index={-1} snapPoints={snapPoints} enablePanDownToClose={true} backdropComponent={renderBackdrop} backgroundStyle={{ backgroundColor: '#1e293b' }} handleIndicatorStyle={{ backgroundColor: '#64748b' }}>
...
const styles = StyleSheet.create({
  ...
  avatarText: { color: '#fff', fontSize: 18, fontFamily: 'Vazir-Bold' },
  ...
  greeting: { fontSize: 20, fontFamily: 'Vazir-Bold', color: '#f8fafc' },
  ...
  heroTitle: { color: '#94a3b8', fontSize: 13, marginBottom: 20, textAlign: 'right', fontFamily: 'Vazir-Bold' },
  ...
  statLabel: { fontSize: 10, color: '#94a3b8', fontFamily: 'Vazir-Bold' },
  ...
  gridText: { color: '#f8fafc', fontFamily: 'Vazir-Bold', fontSize: 14, marginBottom: 4 },
  gridSubText: { color: '#64748b', fontSize: 10, fontFamily: 'Vazir-Regular' },
  ...
  sheetName: { color: '#fff', fontSize: 18, fontFamily: 'Vazir-Bold', textAlign: 'right' },
  sheetRole: { color: '#10b981', fontSize: 13, textAlign: 'right', marginTop: 4, fontFamily: 'Vazir-Regular' },
  ...
  sheetBtnText: { color: '#f8fafc', fontSize: 14, fontFamily: 'Vazir-Bold' }
});